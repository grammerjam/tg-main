...
export default function MockVideoPlayer() {
    ...
    return (
        <div className="w-full rounded-[10px] relative">
            <div>
                <div>
                    <div className={`top-1/2 left-1/2 absolute bg-ma-black rounded-full p-[16px] transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-1000 ease-out ${show ? 'opacity-75' : 'opacity-0'}`}>
                        {playing ?
                    ...
                    {/* <div className={`top-1/2 left-1/2 absolute bg-ma-black rounded-full p-[16px] transform -translate-x-1/2 -translate-y-1/2 transition-opacity ease-out duration-700 opacity-0`}>
                             <svg xmlns="http://www.w3.org/2000/svg" className="fill-white transition-opacity" height="24" viewBox="0 -960 960 960" width="24"><path d="M520-200v-560h240v560H520Zm-320 0v-560h240v560H200Zm400-80h80v-400h-80v400Zm-320 0h80v-400h-80v400Zm0-400v400-400Zm320 0v400-400Z" /></svg>
                        </div>} */}

                    <div
                        className={`
                    absolute bottom-0 left-0 right-0 z-[100] transition-opacity focus-within:opacity-100 py-[16px] px-[24px] flex items-center gap-[16px] text-[16px] ${hover || !playing ? "opacity-100" : "opacity-0"}
                    `}>
